                    ...
                    <li class="nav-header">
                        <div style="margin-left: 30px" class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="${mao}/system/info/form_avatar">修改头像</a>
                                </li>
                                <li><a class="J_menuItem" href="${mao}/system/info/profile">个人资料</a>
                                </li>
                                <li><a class="J_menuItem" href="${mao}/system/info/contacts">联系我们</a>
                                </li>
                                <li><a class="J_menuItem" href="${mao}/system/info/mailbox">信箱</a>
                                </li>
                                <li class="divider"></li>
