                  ...
                  <table id="table"
                    ...
                    <thead>
                      <tr>
                        ...
                        <th data-field="receive_area"  data-halign="center" data-align="center">收取区域</th>
                       	<th data-field="create_time" data-formatter="timeFormatter" data-halign="center" data-align="center">生成时间</</th>
                        <th data-field="customer_id"  data-halign="center" data-align="center">下单客户</th>
...
<myfooter> 
  ...
  <!-- 自定义js --> 
  <script src="${maosta}/exp/js/exOrderAuditList.js"></script> 
</myfooter>
</body>
</html>