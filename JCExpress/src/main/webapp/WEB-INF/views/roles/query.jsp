              ...
              <div class="example-wrap">
                <div class="example">
                  ...
                  <table id="table"
                    ...
                    <thead>
                      <tr>
                        <th data-field="login_name" data-formatter="nameFormatter" data-halign="center" data-align="center" data-sortable="true">订单号</th>
                        <th data-field="user_name" data-halign="center" data-align="center" data-sortable="true">配送人</th>
                        <th data-field="telephone" data-halign="center" data-align="center" data-sortable="true">手机</th>
                        <th data-field="create_time" data-formatter="registerTimeFormatter" data-halign="center" data-align="center" data-sortable="true">配送时间</th>
                        <th data-field="last_login_time" data-formatter="loginTimeFormatter" data-halign="center" data-align="center" data-sortable="true">最后到达时间</th>
