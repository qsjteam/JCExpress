              ...
              <div class="example-wrap">
                <div class="example">
                	<div id="toolbar" class="btn-group">
                     <button type="button" class="btn btn-default"  title="关联分区" onclick="rela_fixed()"> <i class="glyphicon glyphicon-ok">关联分区</i> </button>
              		</div>
                  <table id="table">
                  </table>
                </div>
...
$(function() {
	$table.bootstrapTable({
		url: baselocation + '/fixed/list/noRealPartition',
		height: '550',
		striped: true,
		search: true,
		showRefresh: true,
