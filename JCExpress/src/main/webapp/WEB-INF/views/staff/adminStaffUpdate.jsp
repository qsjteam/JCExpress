    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
         <h5>修改取派员<small><b>用户个人信息时应当遵循合法、正当、必要的原则，明示目的、方式和范围，并经用户同意<big>♂</big></b></small></h5>
        ...
        <div class="ibox-content">
          <form id="form" class="form-horizontal" action="${mao}/staff/list/${staff.id}" data-method="put">
            <div class="form-group m-t">
              ...
              <div class="col-sm-7">
                <input type="text" maxlength="10" class="form-control" value="${staff.name}" name="name">
              </div>
            </div>
            ...
            <div class="form-group m-t">
              ...
              <div class="col-sm-7">
                <input type="text"  class="form-control" value="${staff.telephone}" name="telephone">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <label class="radio-inline">
                  <input type="radio" name="status" value="1" ${staff.status eq '1' ? 'checked="checked"':''}>
               			  启用</label>
                <label class="radio-inline">
                  <input type="radio" name="status" value="0" ${staff.status eq '0' ? 'checked="checked"':''}>
                		  冻结</label>
