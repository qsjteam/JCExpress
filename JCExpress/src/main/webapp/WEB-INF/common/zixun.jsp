...
<div class="m-header-banner m-list-header" style="background: url(${maosta}/assets/images/news-bg.jpg) 50% 0 no-repeat fixed;">
...
<nav class="m-cat-nav">
    <ul class="am-container">
                      <li class="am-active" ><a href="/zixun"><i class="icon-chevron-right"></i>最新资讯</a></li>
                      <li ><a href="/dongtai"><i class="icon-chevron-right"></i>网站动态</a></li>
                      <li ><a href="/help"><i class="icon-chevron-right"></i>帮助中心</a></li>
              </ul>
</nav>
<section class="am-container m-news">
    <div class="m-container am-g">
                <article class="am-cf">
            <div class="am-u-lg-2 am-u-md-12 m-news-date am-hide-md-down"><span class="m-date-num">06</span>2018-05</div>
            <div class="am-u-lg-10 am-u-md-12 am-u-sm-12">
                <h3><a href="/post/141">锦程网络官网v1.1网站小改版</a></h3>
                <div class="m-news-data">
                    <span><i class="am-icon-clock-o"></i> 2018-05-06</span>
                    <span><i class="am-icon-check-square-o"></i> 点击74次</span>
                    <span href="/dongtai"><i class="am-icon-bars"></i> 网站动态</span>
                </div>
                                <p class="m-news-desc">锦程网络官网进行了小修改与新配色，并升级向应式布局，一个网站兼容多个终端，多终端一体化创新设计解决方案。修改更新项目1、大屏的海报，对海报大文字加入了动态的效果。2、更换了新大logo。3、对导航进行了...</p>
                <a href="/post/141" class="am-btn am-btn-danger am-radius am-btn-xs" rel="nofollow">READ MORE</a>
            </div>
        </article>
                <article class="am-cf">
            <div class="am-u-lg-2 am-u-md-12 m-news-date am-hide-md-down"><span class="m-date-num">21</span>2018-05</div>
            <div class="am-u-lg-10 am-u-md-12 am-u-sm-12">
                <h3><a href="/post/29">网站使用说明-添加内容</a></h3>
                <div class="m-news-data">
                    <span><i class="am-icon-clock-o"></i> 2018-05-7</span>
                    <span><i class="am-icon-check-square-o"></i> 点击267次</span>
                    <span href="/help/"><i class="am-icon-bars"></i> 帮助中心</span>
                </div>
                <img src="${maosta}/images/loading.gif" alt="网站使用说明-添加内容" data-echo="uploadfiles/image/201506/26.jpg" class="am-img-responsive">                <p class="m-news-desc">添加内容前面讲过了网站的栏目管理，下面来介绍一下网站的内容是如何添加的。一般企业网站的内容会有几种，有资讯内容、产品内容、招聘内容、还有知识内容等等。先登陆网站的后台，点击顶部导航栏的内容选项，...</p>
            ...
            <div class="am-u-lg-10 am-u-md-12 am-u-sm-12">
                ...
                <div class="m-news-data">
                    <span><i class="am-icon-clock-o"></i> 2018-05-8</span>
            ...
            <div class="am-u-lg-10 am-u-md-12 am-u-sm-12">
                ...
                <div class="m-news-data">
                    <span><i class="am-icon-clock-o"></i> 2018-05-9</span>
            ...
            <div class="am-u-lg-10 am-u-md-12 am-u-sm-12">
                ...
                <div class="m-news-data">
                    <span><i class="am-icon-clock-o"></i> 2018-05-10</span>
                ...
                <article class="am-cf">
            <div class="am-u-lg-2 am-u-md-12 m-news-date am-hide-md-down"><span class="m-date-num">02</span>2018-05</div>
            <div class="am-u-lg-10 am-u-md-12 am-u-sm-12">
                <h3><a href="/post/4">关于网站备案</a></h3>
                <div class="m-news-data">
                    <span><i class="am-icon-clock-o"></i> 2018-05-11</span>
            ...
            <div class="am-u-lg-10 am-u-md-12 am-u-sm-12">
                ...
                <div class="m-news-data">
                    ...
                    <span href="/help/"><i class="am-icon-bars"></i> 帮助中心</span>
                                ...
                                <p class="m-news-desc">首先我们感谢您选择了拉德的产品服务，希望您的事业蒸蒸日上！自网站上线之日起客户将享受6个月免费的售后服务。免费服务&lt;/h2&gt;一、网站日常维护&lt;/h3&gt;网站故障排查：及时发现网页及图片的缺损、断链并修改完成，保证...</p>
            ...
            <div class="am-u-lg-10 am-u-md-12 am-u-sm-12">
                ...
                <div class="m-news-data">
                    <span><i class="am-icon-clock-o"></i> 2018-05-12</span>
...
<div class="m-footer-bottom">
    <div class="am-container">
    <div class="am-g">
        <span class="m-u-sm-12 am-u-md-9 am-u-lg-10">Copyright @ 2018 JCExpress <a href="http://www.miitbeian.gov.cn/" rel="external nofollow">川ICP备xxxxxx号-1</a> 
</span>
