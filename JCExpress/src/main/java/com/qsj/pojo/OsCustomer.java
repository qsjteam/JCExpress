...
public class OsCustomer implements Serializable {
	...
	public String toString() {
		return "OsCustomer [id=" + id + ", customer_telephone=" + customer_telephone + ", password=" + password
				+ ", nickname=" + nickname + ", customer_email=" + customer_email + ", create_time=" + create_time
				+ ", state=" + state + "]";
	}
