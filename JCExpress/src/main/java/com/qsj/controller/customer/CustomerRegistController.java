...
import com.qsj.captcha.sdk.GeetestLib1;
...
public class CustomerRegistController {
	...
	public Object CustomerRegist(HttpServletRequest request, HttpServletResponse response, OsCustomer customer) {
		GeetestLib1 gtSdk = new GeetestLib1(GeetestConfig.getCaptcha_id(), GeetestConfig.getPrivate_key());
		String challenge = request.getParameter(GeetestLib1.fn_geetest_challenge);
		String validate = request.getParameter(GeetestLib1.fn_geetest_validate);
		String seccode = request.getParameter(GeetestLib1.fn_geetest_seccode);
