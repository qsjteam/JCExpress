...
public class GeetestLib1 {
	 ...
	 * @param privateKey
	 */
	public GeetestLib1(String captchaId, String privateKey) {
	...
	public int failbackValidateRequest(String challenge, String validate, String seccode) {
		...
		gtlog(String.format("encode----challenge:%s--ans:%s,bg_idx:%s,grp_idx:%s",
		...
		gtlog(String.format("decode----ans:%s,bg_idx:%s,grp_idx:%s", 
