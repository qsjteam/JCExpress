	...
	i.fn.step = function(e) {
		...
		var a = function() {
				...
				s.length > 0 && (e += '<div class="ui-step-wrap"><div class="ui-step-bg"></div><div class="ui-step-progress"></div><ul class="ui-step">', i.each(s, function(i, t) {
					e += '<li class="ui-step-item"><div class="ui-step-item-title">' + t + '</div><div class="ui-step-item-title">' + f[i] + '</div><div class="ui-step-item-num"><span>' + (i+1) + "</span> </div></li>"
