    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form id="form" class="form-horizontal" action="${mao}/car/list" data-method="post">
            <div class="form-group m-t">
              <label class="col-sm-2 col-xs-offset-1 control-label">车牌号：</label>
              <div class="col-sm-7">
                <input type="text" maxlength="10" class="form-control"  name="car_number">
              </div>
            </div>
            ...
            <div class="form-group m-t">
              ...
              <div class="col-sm-7">
                <input type="text"  class="form-control"  name="car_load">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group m-t">
