              ...
              <div class="example-wrap">
                <div class="example">
                  <div id="toolbar" class="btn-group m-t-sm">
                      <button type="button" class="btn btn-default"  title="创建分区" onclick="layer_show('创建分区','${mao}/partition/list/createPartition','900','650')"> <i class="glyphicon glyphicon-plus"></i> </button>
                  </div>
                  <table id="table"
                         data-toggle="table"
                         data-height="600"
                    ...
                    <thead>
                      <tr>
                        <th data-field="partition_code" data-halign="center" data-align="center" data-sortable="true">分区编号</th>
