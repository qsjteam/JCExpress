...
<nav class="m-cat-nav">
    <ul class="am-container">
                <li ><a href="/about"><i class="icon-chevron-right"></i>关于拉德</a></li>
...
<div class="am-container">
	<section class="am-g m-footer-container">
		<section class="am-u-sm-12 am-u-md-12 am-u-lg-6">
			<h2>关于我们</h2>
			<p>拉德速递成立于2010年，专注高端网站建设、视觉设计、平面设计、广告拍摄、产品摄影、营销策划和品牌网络推广为一体的创新高端公司，拥有超过8年行业经验的资深团队及设计、开发、摄影、营销、开发经验，强悍创新的视觉执行力<a href="/about" rel="nofollow">更多</a></p>
		</section>
...
<div class="m-footer-bottom">
  <div class="am-container">
  <div class="am-g">
    <span class="m-u-sm-12 am-u-md-9 am-u-lg-10">Copyright @ 2018 JCExpress.com <a href="http://www.miitbeian.gov.cn/" rel="external nofollow">川ICP备xxxxxx号-1</a> 
</span>
